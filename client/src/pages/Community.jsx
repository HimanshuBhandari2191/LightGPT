...
const Community = () => {
  ...
  return (
    ...
    overflow-y-scroll">
        ...
        {images.length > 0 ? (
          <div className='flex flex-wrap max-sm:justify-center gap-5'>
            ...
            transition-shadow duration-300'>
              ...
              2xl:h-62 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out'></img>
        ...
        (
        <p className='text-center text-gray-600 dark:text-purple-200 mt-10'>No image available</p>
        )}
    </div>
  )
}
